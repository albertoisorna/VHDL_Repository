/*****************************************************************************
* Filename:          C:\Xilinx\PRACTICAS_FPGA\P3_INTENTO2\ficheros_p1\pr_1/drivers/simon_alb_v1_00_a/src/simon_alb_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the simon_alb driver
...
XStatus SIMON_ALB_SelfTest(void * baseaddr_p)
{
  ...
  SIMON_ALB_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = SIMON_ALB_mReadSlaveReg0(baseaddr, 0);
  ...
  SIMON_ALB_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = SIMON_ALB_mReadSlaveReg1(baseaddr, 0);
