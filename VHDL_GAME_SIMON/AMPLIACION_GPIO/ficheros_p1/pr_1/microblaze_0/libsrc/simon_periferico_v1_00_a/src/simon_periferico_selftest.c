/*****************************************************************************
* Filename:          C:\Xilinx\PRACTICAS_FPGA\P3_INTENTO2\ficheros_p1\pr_1/drivers/simon_periferico_v1_00_a/src/simon_periferico_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the simon_periferico driver
...
XStatus SIMON_PERIFERICO_SelfTest(void * baseaddr_p)
{
  ...
  SIMON_PERIFERICO_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg0(baseaddr, 0);
  ...
  SIMON_PERIFERICO_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg1(baseaddr, 0);
  ...
  SIMON_PERIFERICO_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg2(baseaddr, 0);
  ...
  SIMON_PERIFERICO_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg3(baseaddr, 0);
  ...
  SIMON_PERIFERICO_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg4(baseaddr, 0);
  ...
  SIMON_PERIFERICO_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = SIMON_PERIFERICO_mReadSlaveReg5(baseaddr, 0);
