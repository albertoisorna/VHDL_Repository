...
# C:\Xilinx\PRACTICAS_FPGA\AMPLIACION_GPIO\ficheros_p1\pr_1\system.mhs
# The software specification of the system is in file :
# C:\Xilinx\PRACTICAS_FPGA\AMPLIACION_GPIO\ficheros_p1\pr_1\system.mss
...
KEYPAD_program: $(KEYPAD_OUTPUT) 

$(KEYPAD_OUTPUT) : $(KEYPAD_SOURCES) $(KEYPAD_HEADERS) $(KEYPAD_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/keypad_compiler.opt
	@mkdir -p $(KEYPAD_OUTPUT_DIR) 
	$(KEYPAD_CC) $(KEYPAD_CC_OPT) $(KEYPAD_SOURCES) -o $(KEYPAD_OUTPUT) \
	$(KEYPAD_OTHER_CC_FLAGS) $(KEYPAD_INCLUDES) $(KEYPAD_LIBPATH) \
	$(KEYPAD_CFLAGS) $(KEYPAD_LFLAGS) 
	$(KEYPAD_CC_SIZE) $(KEYPAD_OUTPUT) 
	@echo ""
