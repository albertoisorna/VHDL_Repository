...
# C:\Xilinx\ALBERTO\AMPLIACION_PLB_v2\ficheros_p1\pr_1\system.mhs
# The software specification of the system is in file :
# C:\Xilinx\ALBERTO\AMPLIACION_PLB_v2\ficheros_p1\pr_1\system.mss
...
simon_program: $(SIMON_OUTPUT) 

$(SIMON_OUTPUT) : $(SIMON_SOURCES) $(SIMON_HEADERS) $(SIMON_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/simon_compiler.opt
	@mkdir -p $(SIMON_OUTPUT_DIR) 
	$(SIMON_CC) $(SIMON_CC_OPT) $(SIMON_SOURCES) -o $(SIMON_OUTPUT) \
	$(SIMON_OTHER_CC_FLAGS) $(SIMON_INCLUDES) $(SIMON_LIBPATH) \
	$(SIMON_CFLAGS) $(SIMON_LFLAGS) 
	$(SIMON_CC_SIZE) $(SIMON_OUTPUT) 
	@echo ""
